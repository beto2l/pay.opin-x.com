...
<head>
    ...
    <title>¡Pago exitoso! - Recetario Keto</title>
...
<body>
    <div class="card">
        ...
        <h1>¡Pago exitoso!</h1>
        <p class="lead">Gracias por tu compra. En breve recibirás un correo con el enlace de descarga de tu Recetario Keto.</p>
