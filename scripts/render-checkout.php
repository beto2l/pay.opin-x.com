<?php
/**
 * Plantilla compartida del checkout.
 * Debe incluirse desde /step/<slug>/index.php tras definir:
 *     $PRODUCT_SLUG = '<slug>';
 *     require ...'/scripts/render-checkout.php';
 */
...
// Si el producto no existe, no exponemos nada.
if (!$PRODUCT) {
...
<body>
    <div class="checkout-card">
        ...
        <div class="offer-header">
            <div class="offer-text">
                ...
                <div class="offer-price"><?= htmlspecialchars($PRODUCT['price_display']) ?></div>
                <div class="offer-desc"><?= htmlspecialchars($PRODUCT['offer_desc']) ?></div>
            </div>
                ...
                <div class="col-right">
                    ...
                    <div class="order-box">
                        ...
                        <div class="order-item">
                            ...
                            <span class="oi-name"><?= htmlspecialchars($PRODUCT['name']) ?></span>
                            <span class="oi-qty">&times; 1</span>
                            <span class="oi-price"><?= htmlspecialchars($PRODUCT['price_text']) ?></span>
                        </div>
                        <div class="order-sub">
                            <span>Subtotal</span>
                            <span><?= htmlspecialchars($PRODUCT['price_text']) ?></span>
                        </div>
    ...
    <footer class="site-footer">
        <div class="footer-brand"><?= htmlspecialchars($PRODUCT['brand']) ?> Digital &reg;</div>
