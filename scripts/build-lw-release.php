...
$routes = [
    ...
    'step/recetario-keto/checkout/' => 'step/recetario-keto/checkout.php',
    'step/recetario-keto/success/' => 'step/recetario-keto/success.php',
    'step/compra-nochebuena-keto/' => 'step/compra-nochebuena-keto/index.php',
    'step/compra-nochebuena-keto/checkout/' => 'step/compra-nochebuena-keto/checkout.php',
    'step/compra-nochebuena-keto/success/' => 'step/compra-nochebuena-keto/success.php',
    'step/postres-y-snacks-keto/' => 'step/postres-y-snacks-keto/index.php',
    'step/postres-y-snacks-keto/checkout/' => 'step/postres-y-snacks-keto/checkout.php',
    'step/postres-y-snacks-keto/success/' => 'step/postres-y-snacks-keto/success.php',
